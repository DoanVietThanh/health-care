package thanhdoan.patientservice.dto;
...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Name is required") @Email(message = "Email should be valid") String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "Name is required") @Email(message = "Email should be valid") String email) {
        this.email = email;
    }
